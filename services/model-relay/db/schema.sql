...
CREATE TABLE public.coding_capability_certifications (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    lease_id uuid,
    settlement_generation integer,
    settlement_inference_grant_sha256 text,
    settlement_provider_receipt_set_sha256 text,
    ...
    CONSTRAINT ck_coding_capability_certifications_coding_certificatio_4229 CHECK ((((settlement_generation IS NULL) AND (settlement_inference_grant_sha256 IS NULL) AND (settlement_provider_receipt_set_sha256 IS NULL)) OR (((settlement_generation >= 1) AND (settlement_generation <= 2147483647)) AND (settlement_inference_grant_sha256 ~ '^[0-9a-f]{64}$'::text) AND (settlement_provider_receipt_set_sha256 ~ '^[0-9a-f]{64}$'::text)))),
...
CREATE TABLE public.coding_certification_inference_grants (
    ...
    CONSTRAINT ck_coding_certification_inference_grants_coding_certifi_1c1c CHECK ((((request_count >= 0) AND (request_count <= request_budget)) AND (prompt_tokens >= 0) AND (completion_tokens >= 0) AND (cost_usd_micros >= 0) AND ((active_requests >= 0) AND (active_requests <= 1)))),
    CONSTRAINT ck_coding_certification_inference_grants_coding_certifi_6c43 CHECK ((((octet_length(case_id) >= 1) AND (octet_length(case_id) <= 256)) AND ((octet_length(profile_capability_id) >= 1) AND (octet_length(profile_capability_id) <= 256)) AND (case_id !~ '[[:space:][:cntrl:]]'::text) AND (profile_capability_id !~ '[[:space:][:cntrl:]]'::text) AND (expires_at > created_at) AND (weight_eligible = false))),
    CONSTRAINT ck_coding_certification_inference_grants_coding_certifi_96ae CHECK (((inference_grant_sha256 ~ '^[0-9a-f]{64}$'::text) AND ((bearer_digest IS NULL) OR (bearer_digest ~ '^[0-9a-f]{64}$'::text)) AND ((revoke_bearer_digest IS NULL) OR (revoke_bearer_digest ~ '^[0-9a-f]{64}$'::text)) AND ((broker_public_key IS NULL) OR (broker_public_key ~ '^[A-Za-z0-9_-]{43}$'::text)))),
    CONSTRAINT ck_coding_certification_inference_grants_coding_certifi_b0c8 CHECK (((status = ANY (ARRAY['pending'::text, 'active'::text, 'revoked'::text, 'exhausted'::text])) AND (((status = 'pending'::text) AND (generation = 0) AND (bearer_digest IS NULL) AND (revoke_bearer_digest IS NULL) AND (broker_public_key IS NULL)) OR ((status = 'active'::text) AND (generation > 0) AND (bearer_digest IS NOT NULL) AND (broker_public_key IS NOT NULL)) OR ((status = ANY (ARRAY['revoked'::text, 'exhausted'::text])) AND (bearer_digest IS NULL) AND (broker_public_key IS NULL))) AND ((status = 'revoked'::text) = (revoked_at IS NOT NULL)))),
    CONSTRAINT ck_coding_certification_inference_grants_coding_certifi_bc48 CHECK (((model = 'openai/gpt-5.6-luna'::text) AND (provider_api = 'openrouter'::text) AND (provider_account_guardrail = 'openrouter_private_account_v1'::text) AND (provider_pipeline_policy = 'no_plugins_no_transforms_v1'::text) AND (provider_cache_policy = 'disabled_v1'::text) AND (reasoning_effort = 'medium'::text))),
    CONSTRAINT ck_coding_certification_inference_grants_coding_certifi_d973 CHECK ((((generation >= 0) AND (generation <= 2147483647)) AND ((request_budget >= 1) AND (request_budget <= 256)) AND ((prompt_token_budget >= 1) AND (prompt_token_budget <= 2000000)) AND ((completion_token_budget >= 1) AND (completion_token_budget <= 250000)) AND ((cost_budget_usd_micros >= 1) AND (cost_budget_usd_micros <= 100000000))))
);
...
CREATE TABLE public.coding_inference_grants (
    ...
    CONSTRAINT ck_coding_inference_grants_coding_inference_grants_crypto_check CHECK (((inference_grant_sha256 ~ '^[0-9a-f]{64}$'::text) AND ((bearer_digest IS NULL) OR (bearer_digest ~ '^[0-9a-f]{64}$'::text)) AND ((revoke_bearer_digest IS NULL) OR (revoke_bearer_digest ~ '^[0-9a-f]{64}$'::text)) AND ((broker_public_key IS NULL) OR (broker_public_key ~ '^[A-Za-z0-9_-]{43}$'::text)))),
    ...
    CONSTRAINT ck_coding_inference_grants_coding_inference_grants_state_check CHECK (((status = ANY (ARRAY['pending'::text, 'active'::text, 'revoked'::text, 'exhausted'::text])) AND (((status = 'pending'::text) AND (generation = 0) AND (bearer_digest IS NULL) AND (revoke_bearer_digest IS NULL) AND (broker_public_key IS NULL)) OR ((status = 'active'::text) AND (generation > 0) AND (bearer_digest IS NOT NULL) AND (broker_public_key IS NOT NULL)) OR ((status = ANY (ARRAY['revoked'::text, 'exhausted'::text])) AND (bearer_digest IS NULL) AND (broker_public_key IS NULL))) AND ((status = 'revoked'::text) = (revoked_at IS NOT NULL))))
);


--
-- Name: coding_inference_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.coding_inference_requests (
    request_row_id uuid NOT NULL,
    grant_id uuid NOT NULL,
    ticket_id uuid NOT NULL,
    generation integer NOT NULL,
    ...
    settled_at timestamp with time zone,
    weight_eligible boolean NOT NULL,
    CONSTRAINT ck_coding_inference_requests_coding_inference_requests__6606 CHECK (((status = ANY (ARRAY['started'::text, 'receipt_free_retry'::text, 'complete'::text, 'provider_failure'::text, 'unsettled'::text])) AND (((status = 'started'::text) AND (provider_settlement_sha256 IS NULL) AND (provider_generation_id IS NULL) AND (provider_settlement_json IS NULL) AND (unsettled_reason IS NULL) AND (settled_at IS NULL)) OR ((status = ANY (ARRAY['receipt_free_retry'::text, 'complete'::text, 'provider_failure'::text])) AND (provider_settlement_sha256 IS NOT NULL) AND (provider_settlement_json IS NOT NULL) AND (unsettled_reason IS NULL) AND (settled_at IS NOT NULL)) OR ((status = 'unsettled'::text) AND (provider_settlement_sha256 IS NULL) AND (provider_generation_id IS NULL) AND (provider_settlement_json IS NULL) AND (unsettled_reason = ANY (ARRAY['provider_settlement_unavailable'::text, 'provider_response_lost'::text, 'relay_infrastructure'::text, 'invalid_provider_settlement'::text])) AND (settled_at IS NOT NULL))) AND ((settled_at IS NULL) OR (settled_at >= started_at)) AND (weight_eligible = false))),
    CONSTRAINT ck_coding_inference_requests_coding_inference_requests__8a30 CHECK (((inference_grant_sha256 ~ '^[0-9a-f]{64}$'::text) AND (locked_request_sha256 ~ '^[0-9a-f]{64}$'::text) AND ((provider_settlement_sha256 IS NULL) OR (provider_settlement_sha256 ~ '^[0-9a-f]{64}$'::text)) AND ((provider_generation_id IS NULL) OR (((octet_length(provider_generation_id) >= 1) AND (octet_length(provider_generation_id) <= 256)) AND (provider_generation_id !~ '[[:space:][:cntrl:]]'::text))))),
    CONSTRAINT ck_coding_inference_requests_coding_inference_requests__9e1a CHECK ((((generation >= 1) AND (generation <= 2147483647)) AND ((sequence >= 1) AND (sequence <= 1100)) AND ((request_sequence >= 1) AND (request_sequence <= 256)) AND ((attempt >= 1) AND (attempt <= 3)))),
    CONSTRAINT ck_coding_inference_requests_coding_inference_requests__fd96 CHECK ((((octet_length(case_id) >= 1) AND (octet_length(case_id) <= 256)) AND ((octet_length(profile_capability_id) >= 1) AND (octet_length(profile_capability_id) <= 256)) AND (case_id !~ '[[:space:][:cntrl:]]'::text) AND (profile_capability_id !~ '[[:space:][:cntrl:]]'::text) AND ((provider_settlement_json IS NULL) OR ((octet_length(provider_settlement_json) >= 1) AND (octet_length(provider_settlement_json) <= 65536)))))
);
...
CREATE TABLE public.screening_quarantines (
    ...
    CONSTRAINT ck_screening_quarantines_screening_quarantines_review_n_f832 CHECK (((review_notes_digest IS NULL) OR (review_notes_digest ~ '^[0-9a-f]{64}$'::text))),
...
--
-- Name: coding_certification_inference_grants coding_certification_inference_grants_grant_lease_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_certification_inference_grants
    ADD CONSTRAINT coding_certification_inference_grants_grant_lease_key UNIQUE (grant_id, lease_id);


--
-- Name: coding_certification_inference_grants coding_certification_inference_grants_lease_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_certification_inference_grants
    ADD CONSTRAINT coding_certification_inference_grants_lease_key UNIQUE (lease_id);


--
-- Name: coding_certification_inference_grants coding_certification_inference_grants_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_certification_inference_grants
    ADD CONSTRAINT coding_certification_inference_grants_pkey PRIMARY KEY (grant_id);
...
--
-- Name: coding_inference_requests coding_inference_requests_grant_sequence_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_inference_requests
    ADD CONSTRAINT coding_inference_requests_grant_sequence_key UNIQUE (grant_id, sequence);


--
-- Name: coding_inference_requests coding_inference_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_inference_requests
    ADD CONSTRAINT coding_inference_requests_pkey PRIMARY KEY (request_row_id);


--
-- Name: coding_inference_requests coding_inference_requests_provider_generation_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_inference_requests
    ADD CONSTRAINT coding_inference_requests_provider_generation_key UNIQUE (provider_generation_id);


--
-- Name: coding_inference_requests coding_inference_requests_request_attempt_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_inference_requests
    ADD CONSTRAINT coding_inference_requests_request_attempt_key UNIQUE (grant_id, request_sequence, attempt);


--
-- Name: coding_inference_requests coding_inference_requests_request_id_attempt_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_inference_requests
    ADD CONSTRAINT coding_inference_requests_request_id_attempt_key UNIQUE (grant_id, request_id, attempt);


--
-- Name: coding_inference_requests coding_inference_requests_settlement_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coding_inference_requests
    ADD CONSTRAINT coding_inference_requests_settlement_key UNIQUE (provider_settlement_sha256);
...
--
-- Name: coding_certification_inference_grants_validator_expiry_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coding_certification_inference_grants_validator_expiry_idx ON public.coding_certification_inference_grants USING btree (validator_hotkey, expires_at) WHERE (status = ANY (ARRAY['pending'::text, 'active'::text]));
...
--
-- Name: coding_inference_requests_grant_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coding_inference_requests_grant_status_idx ON public.coding_inference_requests USING btree (grant_id, status, sequence);
...
--
-- Name: coding_certification_inference_grants coding_certification_inference_grants_lease_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: coding_inference_requests coding_inference_requests_grant_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
